...
DST=bin/ymir
INCLUDE=include/value.hs include/error.hs include/variable.hs include/primitives.hs include/ffi.hs include/function.hs include/eval.hs include/parser.hs include/extern.hs include/extern_stub.h
